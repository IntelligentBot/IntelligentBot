    ...
    if data[tostring(msg.to.id)]['settings']['lock_arabic'] == 'yes' then
	  ...
	  if msg.to.type == 'chat' then
		...
		if username and is_super_group(msg) then
			send_large_msg(receiver , "Persian/Arabic Language Is Not Allowed In This Group Dear@"..username.."["..msg.from.id.."]\nStatus: User kicked/msg deleted")
		else
			send_large_msg(receiver , "Persian/Arabic Language Is Not Allowed In This Group: "..name.."["..msg.from.id.."]\nStatus: User kicked/msg deleted")
		end
