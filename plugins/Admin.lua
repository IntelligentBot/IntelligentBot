...
local function run(msg,matches)
    ...
    if matches[1] == "markread" then
    	if matches[2] == "on" then
    		...
    		return "Intelligent Read Messages > on"
    	end
    	if matches[2] == "off" then
    		redis:del("bot:markread")
    		return "Intelligent Read Messages > off"
    	end
    	return
    end
    if matches[1] == "pm" then
    	...
    	return "Message has been sent to intelligent team"
    end
    ...
    if matches[1] == "contactlist" then
      ...
      return "I've Sent Contact List In 2 Format In Your Private!"
    end
   ...
   return "User +"..matches[2].." has been added"
end
